...
// To make the version dynamic, PHP below function used
...
wp_enqueue_style('casinohotel-webpack-css',"/dist/app.css", array(),$version , 'all');
...
wp_enqueue_script('casinohotel-custom-script',  get_template_directory_uri() . '/dist/bundle.js', array(), '1.0', true );
